...
export default function Piechart(){
    ...
    return (
        <div className=' flex flex-col gap-16 justify-center items-center m-28 overflow-hidden'>
            <Pie data = {pieval} className='h-[300px] w-[300px]'/>
            <Line data={data} className='h-[400px] w-[1000px]'/>
        </div>
    )
}